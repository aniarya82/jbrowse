...
function(declare,Faceted) {
    return declare('AnnotationEditor.View.TrackList.Faceted',Faceted,
    {
        ...
        renderGrid:function() {
            ...
            for(var index in this.trackDataStore.identIndex) {
                if(this.trackDataStore.identIndex[index]["track type"]=="AnnotationEditor/View/Track/AnnotTrack" || 
                   this.trackDataStore.identIndex[index]["track type"]=="AnnotationEditor/View/Track/AnnotSequenceTrack") {
