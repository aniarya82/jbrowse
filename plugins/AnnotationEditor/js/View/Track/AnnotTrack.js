define([
        ...
        'AnnotationEditor/JSONUtils',
        'AnnotationEditor/BioFeatureUtils',
        'AnnotationEditor/Permission',
        'AnnotationEditor/SequenceSearch',
        'AnnotationEditor/EUtils',
        ...
        var AnnotTrack = declare(DraggableFeatureTrack, {
            ...
            setViewInfo: function (genomeView, numBlocks,
                ...
                var standby = new Standby({
                    target: track.div,
                    color: "transparent",
                    image: "plugins/AnnotationEditor/img/loading.gif"
                });
